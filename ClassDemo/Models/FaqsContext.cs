        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FAQ>().HasData(
                ...
                new FAQ
                {
                    ...
                    Answer = "Blazor is a free and open-source web framework that enables developers to create interactive web user interfaces using C# and HTML. It is being developed by Microsoft.",
                    CategoryId = "gen",
                    TopicId = "blz"
                },
                new FAQ
