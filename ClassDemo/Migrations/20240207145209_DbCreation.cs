        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Blazor is a free and open-source web framework that enables developers to create interactive web user interfaces using C# and HTML. It is being developed by Microsoft.", "gen", "What is Blazor?", "blz" },
                    { 4, "Blazor was released on May 14 2020", "hist", "When was Blazor released?", "blz" },
                    { 5, "Entity Framework is an open-source ORM framework for .NET applications supported by Microsoft.", "gen", "What is Entity Framework?", "ef" },
